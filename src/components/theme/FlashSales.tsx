...
export default function FlashSales() {
   ...
   <div>
    ...
    <div className='flex md:flex-row flex-col lg:ml-20 p-4'>
        ...
        <div className=' w-[220px] h-[200px] ' id='sale'>
            ...
            <Heart className='bg-white w-5 h-5 rounded-full ml-20 mt-3 text-[20px]'/></div>
            <Eye className='bg-white w-5 h-5 rounded-full ml-48'/>    
            <Image src={fsale2} alt='' width={300} height={300} className='w-28 h-24 ml-14 hover:scale-125 hover:ease-linear'/>
            <h1 className='text-center' id='cart'> Add to cart</h1>
        ...
        <div className=' w-[220px] h-[200px] ' id='sale'>
            ...
            <Heart className='bg-white w-5 h-5 rounded-full ml-20 mt-3 text-[20px]'/></div>
            <Eye className='bg-white w-5 h-5 rounded-full ml-48 '/>    
            <Image src={fsale3} alt='' width={500} height={500} className='w-32 h-24 ml-14 hover:scale-125 hover:ease-linear'/>
            <h1 className='text-center' id='cart'> Add to cart </h1>
        ...
        <div className=' w-[220px] h-[200px] ' id='sale'>
            ...
            <Heart className='bg-white w-5 h-5 rounded-full ml-20 mt-3 text-[20px]'/></div>
            <Eye className='bg-white w-5 h-5 rounded-full ml-48'/>    
            <Image src={fsale4} alt='' width={200} height={200} className='w-16 h-24 ml-16 transition-all hover:scale-150 hover:ease-linear'/>
            <h1 className='text-center' id='cart'> Add to cart</h1>
 ...
 <Button variant={'destructive'} className='md:ml-[550px] ml-24 mt-5 mb-5'>
