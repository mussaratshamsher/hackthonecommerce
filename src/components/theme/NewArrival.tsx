...
{/* pics layout */}
<div className='grid grid-cols-1 md:grid-cols-2 md:ml-10 lg:ml-20 mb-5'>

<Image src={arrival1} alt='' width={500} height={500} 
className='lg:w-[500px] md:h-[400px] lg:h-[480px] w-[300px] h-[250px] 2xl:w-[900px] 2xl:h-[650px] mt-5 ml-2 hover:scale-110'/>

<div className='grid grid-cols-1'>  
    <Image src={arrival2} alt='' width={500} height={500} className='lg:w-[500px] w-[300px] h-[200px] 2xl:w-[900px] 2xl:h-[300px] col-span-1 mt-5 ml-2 hover:scale-110' />  
<div className='grid grid-cols-2'>  
    <Image src={arrival3} alt='' width={250} height={250} className='lg:w-[220px] lg:h-[200px] w-[140px] 2xl:w-[420px] 2xl:h-[300px] md:mt-10 mt-3 ml-2 hover:scale-110' />  
  <div>
    <Image src={arrival4} alt='' width={250} height={250} className='lg:w-[220px] lg:h-[200px] w-[140px] 2xl:w-[420px] 2xl:h-[300px] md:mt-10 mt-3 ml-1 hover:scale-110' />  
